...
* [What is a Database?](database/database-fundamentals.md#what-is-a-database)
* [Why are Databases Important?](database/database-fundamentals.md#why-are-databases-important)
* [Types of Databases](database/database-fundamentals.md#types-of-databases)
* [Database Components](database/database-fundamentals.md#database-components)
* [Database Connectivity Overview](database/database-fundamentals.md#database-connectivity-overview)

**Database Administration & Troubleshooting**

* [ODBC & SQL Server Connectivity](database/odbc-sql-server-connectivity.md)
* [SQL Server Management Studio (SSMS) Basics](database/sql-server-management-studio.md)
* [SQL Server Authentication](database/sql-server-authentication.md)
* [Common Database Connectivity Issues](database/common-database-connectivity-issues.md)
* [Database Backup & Restore Basics](database/database-backup-restore.md)
* [Database Troubleshooting Checklist](database/database-backup-restore.md#database-troubleshooting-checklist)
